...
public class AuthTokenFilter extends OncePerRequestFilter {
	...
	private final PeopleService usuarioService;

	public AuthTokenFilter(JwtUtils jwtUtils, PeopleService usuarioService) {
		super();
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		try {
			...
			if (jwt != null && jwtUtils.validaJwtToken(jwt)) {
				...
				People usuario = (People) usuarioService.loadUserByUsername(emailUsuario);
